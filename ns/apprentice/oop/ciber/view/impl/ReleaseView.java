...
public class ReleaseView implements CiberUI {
    ...
    public CiberUI execute() {
        System.out.println("Ocupied computers");
        System.out.println();
        ...
        System.out.println("Enter id of computer to release:");
        ...
        rentService.releaseComputer(computer);
